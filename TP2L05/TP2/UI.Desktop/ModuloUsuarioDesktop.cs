...
namespace UI.Desktop
{
    public partial class ModuloUsuarioDesktop : AplicationForm
    {
        ...
        public override void MapearDeDatos()
            ...
            this.txtIDModulo.Text = this.MDActual.IDModulo.ToString();           
            this.txtIDUsuario.Text = this.MDActual.IDUsuario.ToString();           
            // Combobox this.txtApellido.Text = this.UsuarioActual.Apellido;      
        ...
        public override void MapearADatos()
            ...
            if (Modo == AplicationForm.ModoForm.Alta)
                ...
                this.MDActual.IDModulo = Convert.ToInt32(this.txtIDModulo.Text);                
